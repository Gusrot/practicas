...
namespace Arrays
{
    public class Aula
    {
        ...
        public int obtenerIndice(Alumno alumno)
        {
            ...
            for ( i = 0; i < 10; i++)
            {
                if (this.listaDeAlumno[i] != null && this.listaDeAlumno[i] == alumno)
        ...
        public void borrarAlumno(Alumno alumno)
        {
            ...
            for (i = 0; i < 10; i++)
            {
                if (this.listaDeAlumno[i] != null && this.listaDeAlumno[i].legajo == alumno.legajo)
                {
